...
const PurchaseOrderList = {
    ...
    formatProducts: products => {
        return products.map(product => `${product.productKey.name} (${product.quantity})`).join(', ');
    },
    ...
    view: vnode => {
        ...
        return m(Card, { title: "Listado de Órdenes de Compra", useCustomPadding: false }, [
            ...
            m(Fila, { gap: 'medium' }, [
                ...
                m(Column, { width: 'auto' }, [
                    m(Button, {
                        type: "primary",
                        label: "Nuevo",
                        onClick: () => m.route.set('/purchase-ordens/new')
                    })
                ])
            ]),
            m(Table, {
