export default class MakeOrderController {
    constructor() {
        // Agregar cualquier inicialización necesaria
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            // Llama a actualizarTabla() inicialmente para que la tabla se muestre correctamente al cargar la página
            actualizarTabla();
